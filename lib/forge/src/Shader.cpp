...
// Gets a filepath as string for a .shader file, and returns the source code for
// each shader.
...
// Gets source code for a shader, and Copile it.
unsigned int Shader::CompileShader(unsigned int type,
  ...
  if (result == GL_FALSE) {
    ...
    GLCall(glGetShaderInfoLog(id, length * sizeof(char), &length, message));
...
// Gets source code for each sub-shader and create a program shader out of it.
